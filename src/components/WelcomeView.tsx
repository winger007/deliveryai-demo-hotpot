      ...
      <div className="relative mx-auto w-full max-w-md px-5 py-10">
        <section className="animate-rise overflow-hidden rounded-3xl border border-white/80 bg-white/90 shadow-float backdrop-blur dark:border-rice-200/10 dark:bg-charcoal-700/90">
          ...
          <div className="px-6 py-8 text-center">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-chili-500/20 bg-chili-50 px-3 py-1.5 text-xs font-bold text-chili-600 dark:border-chili-500/30 dark:bg-chili-500/10 dark:text-chili-500">
