    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent title={t('console.title')} className="md:max-w-2xl">
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-2">
          <section className="rounded-2xl bg-white p-4 shadow-sm dark:bg-charcoal-500/50 dark:shadow-none">
        ...
        <section className="mt-4 rounded-2xl bg-white p-4 shadow-sm dark:bg-charcoal-500/50 dark:shadow-none">
